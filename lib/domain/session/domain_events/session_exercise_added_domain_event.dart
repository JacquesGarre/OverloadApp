...
class SessionExerciseAddedDomainEvent implements DomainEventInterface {
  final UuidValue _aggregateId;
  final UuidValue _eventId;
  final DateTime _occuredAt;
  final Session _session;
  final SessionExercise _sessionExercise;
  static const String _eventName = "SessionExerciseAddedDomainEvent";

  SessionExerciseAddedDomainEvent._(this._aggregateId, this._eventId,
  ...
  static SessionExerciseAddedDomainEvent fromSessionAndSessionExercise(
    ...
    return SessionExerciseAddedDomainEvent._(
      session.id().value(),
      eventId,
      occuredAt,
      session,
