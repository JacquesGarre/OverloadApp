...
class WorkoutUpdatedDomainEvent implements DomainEventInterface {
  final UuidValue _aggregateId;
  final UuidValue _eventId;
  final DateTime _occuredAt;
  final Workout _workout;
  static const String _eventName = "WorkoutUpdatedDomainEvent";

  WorkoutUpdatedDomainEvent._(
    this._aggregateId,
    this._eventId,
    this._occuredAt,
    this._workout,
  ...
  static WorkoutUpdatedDomainEvent fromWorkout(Workout workout) {
    String uuid = const Uuid().v4();
    UuidValue eventId = UuidValue.fromString(uuid);
    DateTime occuredAt = DateTime.now();
    return WorkoutUpdatedDomainEvent._(
      workout.id().value(),
      eventId,
      occuredAt,
      workout,
