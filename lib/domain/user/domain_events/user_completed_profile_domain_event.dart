...
class UserCompletedProfileDomainEvent implements DomainEventInterface {

  final UuidValue _aggregateId;
  final UuidValue _eventId;
  final DateTime _occuredAt;
  final User _user;
  static const String _eventName = "UserCompletedProfileDomainEvent";

  UserCompletedProfileDomainEvent._(this._aggregateId, this._eventId, this._occuredAt, this._user);
  ...
  static UserCompletedProfileDomainEvent fromUser(User user) {
    String uuid = const Uuid().v4();
    UuidValue eventId = UuidValue.fromString(uuid);
    DateTime occuredAt = DateTime.now();
    return UserCompletedProfileDomainEvent._(user.id().value(), eventId, occuredAt, user);
  }
